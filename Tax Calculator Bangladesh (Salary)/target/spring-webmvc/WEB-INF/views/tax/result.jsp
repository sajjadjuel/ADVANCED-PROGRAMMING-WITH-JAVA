...
<form:form action="calculate" modelAttribute="tax">
  ...
  <table width="50%" border="2" style="background-color: darkslategrey; color: aliceblue">
    <tr>
      ...
      <th><form:input type="number" path="investment" id="investment" required="required"/>
        <form:errors path="investment"/>
      </th>
    </tr>
    <tr>
      <th>Payable Tax: </th>
      <th><% out.println(request.getAttribute("payable"));%></>
    </tr>
  </table>

  <br><br>

  <input type="submit" value="Re-Calculate" style="background-color: cornflowerblue; color: white; padding: 6px">
  <a href="Tax_Calculator" type="button" style="background-color: cornflowerblue; padding:0.5%; color: white"> Reset</a>
