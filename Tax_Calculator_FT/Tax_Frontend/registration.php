        ...
        <div class="container "> 
            <div class="popUp-content">
                ...
                <form   method="POST" style="text-align:center; border:1 ; background-color:darkgrey; margin: 0 auto;">
                       <button type="button" style="text-align:center; background-color:Black; color:white; padding:8px">Registration</button>                                           
                        
                       <a class="nav-link" href="userLogin.php" title="Back" role="button" style="text-align:center; background-color:Black; color:white; padding:8px">Login Page</a>
                    <p></p>
                                                      
                <form action='login.php' method='POST' class='form_style signUpForm signUpForm_new' id="signUp_Form">
